...
export function wcAuthHeaders(extra = {}) {
  ...
  return {
    ...
    // Node.js fetch sends no User-Agent by default, which triggers Cloudflare
    // Bot Fight Mode on hosting-provider IPs (Hetzner, DigitalOcean, AWS, etc.).
    'User-Agent': 'FastCart/1.0 (Server-Side WooCommerce Sync; +https://myhappyhour.co.ke)',
    ...extra,
  };
}
