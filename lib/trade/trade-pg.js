...
async function createSchema() {
  ...
  await p.query(`
    ...
    -- Paystack payment columns on trade_orders
    ALTER TABLE trade_orders ADD COLUMN IF NOT EXISTS paystack_reference VARCHAR(255);
    ALTER TABLE trade_orders ADD COLUMN IF NOT EXISTS paystack_transaction_id VARCHAR(64);
    ALTER TABLE trade_orders ADD COLUMN IF NOT EXISTS paystack_amount VARCHAR(32);
    ALTER TABLE trade_orders ADD COLUMN IF NOT EXISTS paystack_channel VARCHAR(32);
