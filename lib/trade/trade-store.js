...
export async function findOrCreateGuestTradeAccount({ name, phone, email, addressLine, city }) {
  ...
  await query(
    `INSERT INTO trade_accounts (
      ...
      licence_expiry, price_book, tier_override, credit_enabled, credit_limit,
      credit_terms, credit_used, clean_orders, order_ceiling, points,
      referral_credit, addresses, default_address_id, terms_accepted,
    ...
    [
      ...
      account.creditUsed,
      account.cleanOrders,
      account.orderCeiling,
      account.points,
      account.referralCredit,
