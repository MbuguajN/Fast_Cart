...
const LINE_ECONOMICS_FIELDS = [
  ...
  'totalCostSnapshot',
  'marginPercent',
  // Raw landed cost and the formula-suggested (pre-override) price — same
  // confidentiality concern as the snapshot fields above, just named
  // differently on the line (see resolveLineTier / calculateTradeOrderPricing).
  'prkCostIncVat',
  'suggestedUnitPriceIncVat',
];
