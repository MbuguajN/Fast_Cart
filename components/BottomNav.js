              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-2.5">
                  <a
                    ...
                    rel="noopener noreferrer"
                    aria-label="Facebook"
                    className="w-9 h-9 rounded-xl bg-gray-100 hover:bg-[#1877F2] text-gray-700 hover:text-white flex items-center justify-center transition-all"
                  >
                  ...
                  <a
                    ...
                    className="w-9 h-9 rounded-xl bg-gray-100 hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] text-gray-700 hover:text-white flex items-center justify-center transition-all"
                  >
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    aria-label="TikTok"
                    className="w-9 h-9 rounded-xl bg-gray-100 hover:bg-black text-gray-700 hover:text-white flex items-center justify-center transition-all"
                  >
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
